...
const Footer = () => {
  ...
  return (
    <>
      <footer className="bg-[#00122B] text-white border-t border-white/5 relative overflow-hidden">
            ...
            <div className="col-span-1 md:col-span-2 space-y-6">
              <div>
                <Link to="/" className="group inline-block">
                  <h2 className="text-xl sm:text-2xl font-black text-white uppercase tracking-tight group-hover:text-blue-400 transition-colors">{SITE_NAME}</h2>
                  <div className="h-1 w-10 bg-blue-500 mt-2 rounded-full group-hover:w-16 transition-all duration-500" />
                  <p className="text-[9px] sm:text-[10px] text-blue-400 font-black uppercase tracking-[0.4em] mt-3">{SITE_TAGLINE}</p>
                </Link>
              </div>
            ...
            <div className="col-span-1 md:col-span-1">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3 group">
                  <div className="p-2 rounded-lg bg-white/5 border border-white/10 text-blue-400 group-hover:bg-blue-600 group-hover:text-white transition-all">
                    <Mail size={14} />
                  </div>
                  <div>
          ...
          <div className="border-t border-white/5 mt-10 sm:mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="group p-1.5 rounded-full border border-white/5 hover:border-blue-500/20 hover:bg-blue-500/5 transition-all duration-500 opacity-40 hover:opacity-100"
                aria-label="Admin console access"
                title="Command Terminal"
              >
                <div className="flex gap-1 px-1.5 py-0.5">
                  <span className="w-0.5 h-0.5 bg-slate-600 rounded-full group-hover:bg-blue-500 transition-colors" />
                  <span className="w-0.5 h-0.5 bg-slate-600 rounded-full group-hover:bg-blue-500 transition-colors duration-300" />
                  <span className="w-0.5 h-0.5 bg-slate-600 rounded-full group-hover:bg-blue-500 transition-colors duration-500" />
                </div>
              </button>
            </div>
