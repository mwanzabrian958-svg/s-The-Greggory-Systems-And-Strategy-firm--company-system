    ...
    <div className="relative" ref={wrapRef}>
      <div className="relative">
        ...
        <input
          ...
          className={
            isAdminTheme
              ? "w-full pl-10 pr-8 py-2 rounded-xl bg-white/5 border border-white/10 text-white text-[11px] font-bold focus:outline-none focus:ring-2 focus:ring-[#002D62] dark:focus:ring-blue-500 transition-all placeholder-slate-500"
              : darkMode
              ? "w-full pl-10 pr-8 py-1.5 rounded-xl bg-slate-800 border border-slate-600 text-white text-[10px] font-bold focus:outline-none focus:ring-2 focus:ring-[#002D62] dark:focus:ring-blue-500 transition-all placeholder-slate-500"
              : "w-full pl-10 pr-8 py-1.5 rounded-xl bg-slate-50 border border-slate-300 text-slate-900 text-[10px] font-bold focus:outline-none focus:ring-2 focus:ring-[#002D62] dark:focus:ring-blue-500 transition-all placeholder-slate-400"
          }
        />
        {loading && <RefreshCw className="absolute right-2 top-1/2 -translate-y-1/2 h-3.5 w-3.5 animate-spin text-[#002D62] dark:text-blue-500" />}
        {!loading && query && (
          <button
        ...
        >
          {error ? (
            ...
            <div className="max-h-[320px] overflow-y-auto custom-scrollbar p-1">
              ...
              <div
                className={`flex items-center justify-center gap-1 p-2 text-[8px] font-black uppercase cursor-pointer ${isAdminTheme ? "text-slate-500 hover:text-blue-400" : darkMode ? "text-slate-500 hover:text-blue-400" : "text-slate-500 hover:text-blue-700"}`}
