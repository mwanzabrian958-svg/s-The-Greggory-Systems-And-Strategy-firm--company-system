...
export default class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-[#00122B] flex flex-col items-center justify-center text-white p-4">
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 max-w-md w-full text-center">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-blue-700 text-white rounded-xl text-[8px] font-black uppercase tracking-widest hover:bg-blue-500 transition-all"
            >
              Recover
            </button>
          </div>
