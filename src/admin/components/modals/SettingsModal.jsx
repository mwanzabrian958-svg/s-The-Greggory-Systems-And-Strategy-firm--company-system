                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-3 gap-4">
                      <button
                        ...
                        className={`p-4 bg-white rounded-xl border-2 transition-colors ${!darkMode ? 'border-blue-600' : 'border-slate-300 hover:border-slate-400'}`}
                      >
                        <Sun className={`w-8 h-8 mx-auto mb-2 ${!darkMode ? 'text-blue-500' : 'text-slate-400'}`} />
                        <p className={`font-medium text-center ${!darkMode ? 'text-blue-700' : 'text-slate-900'}`}>Light Theme</p>
                      </button>
                      <button
                        onClick={() => setDarkMode(true)}
                        className={`p-4 bg-white rounded-xl border-2 transition-colors ${darkMode ? 'border-blue-600 shadow-[0_0_15px_rgba(59,130,246,0.2)]' : 'border-slate-300 hover:border-slate-400'}`}
                      >
                        <Moon className={`w-8 h-8 mx-auto mb-2 ${darkMode ? 'text-blue-500' : 'text-slate-700'}`} />
                        <p className={`font-medium text-center ${darkMode ? 'text-blue-700' : 'text-slate-900'}`}>Deep Space Theme (Dark)</p>
                      </button>
                      <button
                ...
                <div className="bg-slate-50 rounded-2xl p-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input type="text" placeholder="Optional - payments use M-Pesa Send Money" className="w-full px-4 py-2.5 rounded-xl border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none" />
                    </div>
                    <div>
