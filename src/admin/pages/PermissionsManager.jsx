            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={() => setEditing(editing === roleIdx ? null : roleIdx)}
                  ...
                  <Check size={12} className={editing === roleIdx ? "text-blue-700" : ""} />
                </button>
              </div>
            </div>
            {editing === roleIdx ? (
              ...
              <div className="flex flex-wrap gap-1">
                ...
                {role.permissions.map(p => {
                  ...
                  return perm ? (
                    <span key={p} className="text-[6px] font-black uppercase px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 border border-blue-200">
                      {perm.label}
                    </span>
                  ) : null;
                })}
