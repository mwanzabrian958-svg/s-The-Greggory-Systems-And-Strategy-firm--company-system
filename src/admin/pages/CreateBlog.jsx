    ...
    <div className="fixed inset-0 bg-[#00122B] z-[500] flex flex-col overflow-hidden font-sans">
      <div className="bg-[#00122B] px-6 py-3 flex items-center justify-between border-b border-white/5 flex-shrink-0">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-blue-500/10 rounded-lg flex items-center justify-center text-blue-500 border border-blue-500/20"><FileText size={16} /></div>
          <div className="hidden sm:block">
            <h2 className="text-lg font-black text-white uppercase leading-none tracking-tighter">Manuscript Deployment</h2>
            <p className="text-[6px] text-blue-500 font-black uppercase tracking-[0.4em] mt-1">Strategic Relay</p>
          </div>
        </div>
      ...
      <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto bg-slate-950 p-6 pb-24">
        <div className="max-w-5xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
              <section className="space-y-4 bg-white/2 p-5 rounded-2xl border border-white/5">
                <div className="flex items-center gap-2 text-blue-500 border-b border-white/5 pb-2"><Type size={10} /><h4 className="text-[8px] font-black uppercase tracking-[0.2em]">Manuscript Data</h4></div>
                <div className="grid gap-4">
                  <div><label className="block text-[6px] font-black text-slate-500 uppercase tracking-widest mb-1 px-1">Primary Title</label><input type="text" placeholder="Strategic title..." value={form.title} onChange={(e) => setForm({ ...form, title: e.target.value })} className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-[10px] font-bold text-white outline-none focus:border-blue-500" required /></div>
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-[9px] font-medium text-slate-300 outline-none h-[350px] resize-none leading-relaxed focus:border-blue-500"
                      required
                    />
            ...
            <div className="space-y-6">
               <section className="space-y-4 bg-white/2 p-5 rounded-2xl border border-white/5 h-full">
                  ...
                  <div className="grid gap-4">
                    <div><label className="block text-[6px] font-black text-slate-500 uppercase tracking-widest mb-1 px-1">Classification</label><select value={form.category} onChange={(e) => setForm({ ...form, category: e.target.value })} className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-[9px] font-bold text-white outline-none focus:border-blue-500"><option value="Strategic Systems" className="bg-[#00122B]">Strategic Systems</option><option value="Operational Excellence" className="bg-[#00122B]">Operational Excellence</option><option value="Financial Intelligence" className="bg-[#00122B]">Financial Intelligence</option><option value="Tech Insights" className="bg-[#00122B]">Tech Insights</option></select></div>
          ...
          <div className="lg:col-span-3 bg-[#00122B] rounded-2xl p-6 border border-white/10 shadow-2xl flex flex-col md:flex-row justify-between items-center gap-6 mt-4">
            <div className="flex gap-6"><div className="bg-white/5 px-6 py-3 rounded-xl border border-white/10"><p className="text-[6px] font-black text-slate-500 uppercase tracking-widest mb-0.5">Status</p><p className="text-lg font-black text-blue-400 leading-none">READY</p></div></div>
