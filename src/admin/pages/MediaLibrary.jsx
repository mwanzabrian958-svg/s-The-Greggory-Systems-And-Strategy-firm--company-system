  ...
  return (
    <div className="space-y-6 w-full">
      <div className="flex items-center justify-between">
        ...
        <label className="flex items-center gap-2 px-4 py-2 bg-blue-700 text-white rounded-xl text-[8px] font-black uppercase tracking-widest cursor-pointer hover:bg-blue-800">
