...
export function BlogPreview() {
  ...
  if (loading) {
    return (
      <div className="fixed inset-0 bg-[#00122B] flex items-center justify-center">
    ...
    <div className="fixed inset-0 bg-[#00122B] z-[500] flex flex-col overflow-hidden font-sans">
      ...
      <div className="bg-[#00122B] px-6 py-3 flex items-center justify-between border-b border-white/5 flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:block">
            ...
            <p className="text-[6px] text-blue-500 font-black uppercase tracking-[0.4em] mt-1">Strategic Relay View</p>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto bg-slate-950 p-6 md:p-12">
        <article className="max-w-4xl mx-auto space-y-10">
          ...
          <div className="pt-20 pb-10 flex flex-col items-center">
            <div className="w-px h-10 bg-gradient-to-b from-blue-500/50 to-transparent mb-4"></div>
      ...
      <footer className="bg-[#00122B] border-t border-white/5 p-6 flex justify-between items-center flex-shrink-0">
         ...
         <div className="flex gap-4">
           <button onClick={() => navigate(`/admin/content/create`)} className="px-6 py-2 bg-blue-700 hover:bg-blue-800 text-white rounded-xl text-[8px] font-black uppercase tracking-widest transition-all">Edit Node</button>
