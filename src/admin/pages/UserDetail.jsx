    ...
    <div className="flex flex-col font-sans text-slate-900 animate-in fade-in duration-300 print:bg-white print:text-black print:relative print:inset-auto print:h-auto print:overflow-visible">
      ...
      <style>{`
        @media print {
          ...
          .company-name {
            color: #002D62 !important; /* Company Teal */
      ...
      <div className="h-16 border-b border-slate-100 flex items-center justify-between px-6 bg-white no-print">
         <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:block">
               ...
               <p className="text-[7px] text-blue-700 font-black uppercase tracking-[0.3em] mt-1.5">{roleType?.toUpperCase()} NODE: {user.id}</p>
            </div>
         </div>
         ...
         <div className="flex items-center gap-3">
            <button
              onClick={handlePrint}
              className="flex items-center gap-2 px-4 py-2 bg-blue-700/10 hover:bg-blue-700 text-blue-700 hover:text-white border border-blue-700/20 rounded-xl text-[8px] font-black uppercase tracking-widest transition-all shadow-lg group"
            >
            ...
            <button onClick={() => navigate(`/admin/users/manage/${user.id}?role_type=${roleType}`)} className="flex items-center gap-2 px-4 py-2 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-xl text-[8px] font-black uppercase tracking-widest transition-all text-slate-600">
               <Edit2 size={12} className="text-blue-700" /> Modify Node
            </button>
         </div>
      </div>
              ...
              <div className="lg:col-span-4 space-y-6">
                 <div className="bg-white border border-slate-200 rounded-[40px] p-8 text-center shadow-xl relative overflow-hidden group">
                    ...
                    <div className="relative mb-6 inline-block">
                       <div className="w-32 h-32 rounded-[48px] bg-slate-50 border-2 border-blue-500/20 flex items-center justify-center overflow-hidden shadow-xl mx-auto">
                          {!imageError ? (
                       ...
                       <div className="absolute -bottom-2 -right-2 bg-blue-500 p-2.5 rounded-2xl border-4 border-white shadow-xl text-white"><Shield size={14} /></div>
                    </div>
                    <h3 className="text-xl font-black uppercase tracking-tight text-slate-900">{user.display_name}</h3>
                    <p className="text-[8px] font-black text-blue-700 uppercase tracking-[0.4em] mt-2 mb-8">{user.role || user.primary_role || 'Personnel'}</p>
                    <div className="grid grid-cols-2 gap-2">
                       ...
                       <div className="bg-slate-50 rounded-2xl p-3 border border-slate-100">
                          ...
                          <p className={`text-[9px] font-black text-blue-700 uppercase mt-1`}>Cleared</p>
                       </div>
                    </div>
                 </div>
              ...
              <div className="lg:col-span-8 space-y-8">
                 <div className="bg-white border border-slate-200 rounded-[40px] p-8 shadow-xl relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                       <div className="flex items-center gap-3 mb-8 text-blue-700"><Activity size={18} /><h4 className="text-[11px] font-black uppercase tracking-widest">Node Analysis</h4></div>
                         ...
                         <div key={proj.id} onClick={() => navigate('/admin/projects')} className="bg-white border border-slate-200 p-5 rounded-[30px] flex items-center justify-between group hover:bg-slate-100 cursor-pointer transition-all shadow-sm">
                            ...
                            <div className="flex items-center gap-6">
                               <div className="text-right hidden md:block">
                                  ...
                                  <p className="text-[10px] font-black text-blue-700 mt-0.5">{proj.progress_percentage}%</p>
                               </div>
      ...
      <div className="hidden print:flex print-container p-12 bg-white min-h-screen text-slate-900 flex-col">
         ...
         <div className="flex justify-between items-start w-full border-b-2 border-slate-100 pb-8 mb-10">
            ...
            <div className="flex items-start gap-4">
               ...
               <div className="company-brand text-left">
                  <div className="text-[#002D62] text-3xl font-black uppercase tracking-tighter leading-none">Greggory Systems</div>
                  <div className="text-[#002D62] text-3xl font-black uppercase tracking-tighter leading-none" style={{ marginTop: '-4px' }}>& Strategy Firm</div>
            ...
            <div className="flex flex-col items-end gap-3">
               <div className="bg-[#002D62]/10 px-4 py-2 rounded-lg border border-[#002D62]/20 text-right">
                  <p className="text-[10px] font-black text-[#002D62] uppercase tracking-[0.4em]">Personnel Identity Report</p>
               </div>
         ...
         <div className="print-content w-full flex flex-col items-end space-y-4">
            ...
            <div className="section-title text-[#002D62] text-[11px] font-black uppercase tracking-widest border-b-2 border-[#002D62]/20 pb-1 mb-2 w-fit">Primary Identification Matrix</div>
            ...
            <div className="section-title text-[#002D62] text-[11px] font-black uppercase tracking-widest border-b-2 border-[#002D62]/20 pb-1 mt-6 mb-2 w-fit">Emergency Connectivity</div>
            {[
            ...
            <div className="section-title text-[#002D62] text-[11px] font-black uppercase tracking-widest border-b-2 border-[#002D62]/20 pb-1 mt-6 mb-2 w-fit">Operational Mission Briefing</div>
            ...
            {projects.length > 0 && (
               <>
                  <div className="section-title text-[#002D62] text-[11px] font-black uppercase tracking-widest border-b-2 border-[#002D62]/20 pb-1 mt-6 mb-2 w-fit">Active System Deployments</div>
                  {projects.map(p => (
         ...
         <div className="mt-auto pt-10 border-t border-slate-100 flex justify-between items-center w-full text-slate-400">
            ...
            <div className="text-[6.5px] font-black uppercase tracking-widest text-[#002D62]">
