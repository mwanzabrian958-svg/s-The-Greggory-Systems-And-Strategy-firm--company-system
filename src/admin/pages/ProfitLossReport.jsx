...
export function ProfitLossReport() {
  ...
  if (loading) return <div className="fixed inset-0 bg-[#00122B] flex items-center justify-center text-white"><RefreshCw className="animate-spin" /></div>;

  return (
    <div className="fixed inset-0 bg-[#00122B] z-[500] flex flex-col overflow-hidden font-sans">
      <div className="bg-[#00122B] p-8 flex items-center justify-between border-b border-white/5 relative flex-shrink-0">
      ...
      <div className="bg-[#00122B] p-10 border-t border-white/5 flex justify-between items-center flex-shrink-0">
