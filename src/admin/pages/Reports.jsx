  ...
  return (
    <div className="space-y-6 animate-fade-in font-sans w-full pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button onClick={downloadReport} className="flex items-center gap-2 bg-blue-700 hover:bg-blue-800 text-white rounded-xl px-5 py-3 text-[9px] font-black uppercase tracking-widest shadow-lg shadow-blue-700/20 transition-all w-fit">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {Object.entries(statusCounts).map(([status, count]) => (
                <div key={status}>
                  ...
                  <div className="h-2 bg-slate-100 rounded-full overflow-hidden">
                    <div className="h-full bg-blue-500 rounded-full transition-all duration-500" style={{ width: `${(count / maxStatus) * 100}%` }}></div>
                  </div>
                </div>
              ))}
        ...
        <div className="bg-white rounded-3xl shadow-lg border border-slate-100 p-6">
          ...
          <button onClick={() => exportCsv(data.invoices, 'invoices.csv')} className="w-full py-2.5 border border-slate-200 hover:border-blue-500 rounded-xl text-[8px] font-black text-slate-600 uppercase tracking-widest transition-all flex items-center justify-center gap-2">
        ...
        <div className="bg-white rounded-3xl shadow-lg border border-slate-100 p-6">
          ...
          {topExpenses.length === 0 ? (
            ...
            <div className="space-y-4">
              ...
              <button onClick={() => exportCsv(data.entries, 'ledger.csv')} className="w-full mt-2 py-2.5 border border-slate-200 hover:border-blue-500 rounded-xl text-[8px] font-black text-slate-600 uppercase tracking-widest transition-all flex items-center justify-center gap-2">
