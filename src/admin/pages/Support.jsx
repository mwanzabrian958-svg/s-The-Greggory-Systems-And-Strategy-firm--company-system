  ...
  if (loading)
    return (
      <div className="flex items-center justify-center py-20">
        <RefreshCw className="animate-spin text-blue-700 w-6 h-6" />
      </div>
    );
    ...
    <div className="space-y-6 animate-fade-in font-sans w-full">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-1.5 rounded-xl bg-blue-700 text-white font-black text-[8px] uppercase tracking-widest shadow-md hover:bg-blue-800 transition-all"
        >
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <section className="bg-white rounded-2xl p-5 border border-slate-100 shadow-xl overflow-hidden">
          ...
          <div className="relative mb-3">
            <input
              ...
              className="w-full pl-7 pr-3 py-1.5 rounded-lg border border-slate-200 text-[7px] font-black uppercase placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-blue-500"
            />
        ...
        <section className="bg-[#00122B] rounded-2xl p-5 border border-white/5 shadow-xl overflow-hidden flex flex-col">
                ...
                <div key={t.id} className="p-3 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 transition-all">
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0">
                      ...
                      <p className="text-[7px] font-bold text-blue-400 uppercase tracking-widest mt-0.5 truncate">
                ...
                <div key={cr.id} className="p-3 rounded-xl bg-white/5 border border-white/5 hover:border-blue-500/20 transition-all">
                  <div className="flex items-start justify-between gap-2 mb-1.5">
                    <div className="min-w-0">
                      ...
                      {cr.project_name ? (
                        <p className="text-[6px] text-blue-400 font-bold uppercase mt-0.5 truncate">Project: {cr.project_name}</p>
                      ) : null}
                    </div>
                    <span
