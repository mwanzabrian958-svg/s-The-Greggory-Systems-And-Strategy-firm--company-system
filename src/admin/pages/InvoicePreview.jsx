...
export function InvoicePreview() {
  ...
  if (!invoice) return <div className="fixed inset-0 bg-[#00122B] flex items-center justify-center text-white">Invoice Not Found <button onClick={() => navigate('/admin/billing')} className="ml-4 underline">Back</button></div>;
  ...
  return (
    <div className="fixed inset-0 bg-[#00122B] z-[500] flex flex-col overflow-y-auto">
      <div className="bg-[#00122B] px-10 py-6 flex justify-between items-center border-b border-white/5 no-print sticky top-0 z-[510]">
         ...
         <div className="flex gap-4">
            ...
            <a href={getApiUrl(`/api/documents/invoices/${id}/pdf`)} className="flex items-center gap-3 bg-blue-700 text-white px-8 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-blue-500 transition-all border border-blue-500"><Download size={16} /> Download PDF</a>
            <a href={getApiUrl(`/api/pdf/completion/invoices/${id}`)} className="flex items-center gap-3 bg-white/5 text-blue-300 px-8 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-blue-700 hover:text-white transition-all border border-blue-500/40"><BadgeCheck size={16} /> Completion PDF</a>
      ...
      <div className="flex-1 bg-slate-900/50 py-20 px-4 flex justify-center">
         <div className="bg-white shadow-[0_0_100px_rgba(0,0,0,0.8)] w-full max-w-[850px] text-slate-900 relative min-h-[700px] lg:min-h-[1150px] font-sans printable-area rounded-sm overflow-hidden">
            <div className="p-8 sm:p-12 lg:p-16">
               ...
               <div className="bg-[#00122B] text-white mb-8 overflow-hidden">
                  <div className="flex justify-between items-center px-8 lg:px-12 py-9">
                     <div>
                        ...
                        <p className="text-base lg:text-lg font-black text-blue-300 leading-tight">AND STRATEGY FIRM</p>
                        <p className="text-[8px] lg:text-[9px] font-bold text-blue-200/80 uppercase tracking-[0.25em] mt-2">Strategic Projects, Systems &amp; Business Solutions</p>
                     </div>
                     <div className="text-right">
                        <p className="text-5xl lg:text-6xl font-black text-blue-500 uppercase tracking-tight leading-none">{docTitle}</p>
               ...
               <div className="h-[3px] bg-blue-700 w-full mb-8" />
               ...
               <table className="w-full mb-8">
                  <thead>
                     <tr className="bg-[#00122B] text-white">
            ...
            {/* Payment instructions + totals */}
               <div className="flex flex-col sm:flex-row justify-between gap-8 mb-4">
                  <div className="bg-blue-50 border-l-4 border-blue-700 p-5 rounded-sm max-w-sm">
                     <p className="text-[8px] font-black text-blue-800 uppercase tracking-[0.2em] mb-3">How to Pay — M-Pesa Send Money</p>
                  ...
                  <div className="w-full sm:w-72 space-y-2.5 sm:pt-1">
                     ...
                     <div className="flex justify-between items-center pt-3 border-t-2 border-slate-900">
                        ...
                        <span className="text-2xl font-black text-blue-700 tracking-tight">{fmt(grandTotal)}</span>
                     </div>
                  </div>
               </div>
