// Client-side Socket.IO event contracts.
// Mirrors the server contract in backend/types/socket.d.ts, WITHOUT the
// server-only NodeJS.Global.io global declaration.
